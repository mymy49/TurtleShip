...
#ifndef YSS_GUI_FRAME_BUFFER_ARGB1555__H_
#define YSS_GUI_FRAME_BUFFER_ARGB1555__H_

#include "FrameBuffer.h"
#include "Brush.h"

class FrameBufferArgb1555 : public FrameBuffer, public Brush
{
public :
	FrameBufferArgb1555(void);
